    ...
    colors: [
      {
        id: 1,
        name: 'черный',
        images: ['src/utils/images/1/black_front.png', 'src/utils/images/1/black_back.png'],
        price: '123.00',
      ...
      },
      {
        id: 2,
        name: 'белый',
        images: ['src/utils/images/1/white_front.png', 'src/utils/images/1/white_back.png'],
        price: '125.00',
      ...
      },
      {
        id: 3,
        name: 'серый',
        images: ['src/utils/images/1/gray_front.png', 'src/utils/images/1/gray_back.png'],
        price: '120.00',
    ...
    colors: [
      {
        id: 1,
        name: 'желтый',
        images: ['src/utils/images/2/yellow_front.png', 'src/utils/images/2/yellow_back.png'],
        price: '88.00',
      ...
      },
      {
        id: 2,
        name: 'синий',
        images: ['src/utils/images/2/blue_front.png', 'src/utils/images/2/blue_back.png'],
        price: '89.00',
      ...
      },
      {
        id: 3,
        name: 'черный',
        images: ['src/utils/images/2/black_front.png', 'src/utils/images/2/black_back.png'],
        price: '90.00',
